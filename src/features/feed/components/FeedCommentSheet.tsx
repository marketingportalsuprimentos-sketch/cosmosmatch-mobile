  ...
  const handleSend = () => {
    ...
    postComment(
      ...
      }, 
      {
        ...
        // --- CORREÇÃO AQUI ---
        onError: (error: any) => {
          // Se for erro de pagamento (402), fechamos a gaveta IMEDIATAMENTE
          // para não travar a tela quando o usuário voltar do Premium.
...
const styles = StyleSheet.create({
  ...
  header: { 
    alignItems: 'center', padding: 15, borderBottomWidth: 1, borderBottomColor: '#1F2937',
  ...
  input: { 
    ...
    paddingHorizontal: 15, paddingVertical: 10, color: 'white', maxHeight: 100,
