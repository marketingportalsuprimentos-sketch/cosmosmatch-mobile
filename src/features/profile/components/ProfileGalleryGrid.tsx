...
// --- NOVO: CÁLCULO DE ALTURA MÁXIMA (Limitar a 2 linhas visíveis) ---
// Altura = (Tamanho da Imagem * 2 linhas) + 1 espaço de Gap
    ...
    return (
        <View style={styles.card}>
            ...
            <View style={{ height: photos.length > 6 ? MAX_GRID_HEIGHT : 'auto' }}>
                <ScrollView 
                    nestedScrollEnabled={true} // Permite rolar dentro da tela principal
                    showsVerticalScrollIndicator={true}
                    indicatorStyle="white"
                    contentContainerStyle={{ paddingBottom: 4 }} // Espacinho no final
                >
             ...
             {isOwner && photos.length === 0 && (
                 <Text style={styles.emptyTextHint}>Toque no + para adicionar sua primeira foto.</Text>
             )}
        </View>
    );
};
